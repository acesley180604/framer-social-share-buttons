  ...
  function init(){
    ...
    for(var i=0;i<imgs.length;i++){
      (function(img){
        ...
        if(img.closest("a"))return; // Skip images inside anchor tags to avoid nested click conflicts
        ...
        platforms.forEach(function(pid){
          ...
          btn.onclick=function(e){e.preventDefault();e.stopPropagation();shareImage(pid,img.currentSrc||img.src,document.title)};
...
(function(){
  ...
  function init(){
    ...
    var msgP=document.createElement("p");msgP.style.cssText="font-size:16px;font-weight:600;margin:0 0 12px";msgP.textContent=cfg.message||"Share to unlock this content";gate.appendChild(msgP);var btnsDiv=document.createElement("div");btnsDiv.className="ssb-locker-btns";btnsDiv.style.cssText="display:flex;gap:8px;justify-content:center;flex-wrap:wrap";gate.appendChild(btnsDiv);
